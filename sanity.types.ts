...
// Query: *[_type == "startup" && defined(slug.current) && !defined($search) || category match $search || title match $search || author->name match $search ] {  _id,   title,   slug,  _createdAt,  author -> {    _id, name, image, bio  },   views,  description,  category,  image,}
...
// Variable: STARTUPS_QUERY_FOR_VIEWS
// Query: *[_type == "startup" &&  _id==$id][0]{    views,}
export type STARTUPS_QUERY_FOR_VIEWSResult = {
  views: number | null;
} | null;
// Variable: GET_AUTHOR_BY_GITHUB_ID
// Query: *[_type == "author" &&  id==$id][0]{  _id,  id,  name,  username,  email,  image,  bio,}
export type GET_AUTHOR_BY_GITHUB_IDResult = {
  _id: string;
  id: number | null;
  name: string | null;
  username: string | null;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"startup\" &&  _id==$id][0]{\n    views,\n}\n": STARTUPS_QUERY_FOR_VIEWSResult;
    "*[_type == \"author\" &&  id==$id][0]{\n  _id,\n  id,\n  name,\n  username,\n  email,\n  image,\n  bio,\n}\n": GET_AUTHOR_BY_GITHUB_IDResult;
    "*[_type == \"author\" &&  _id==$id][0]{\n  _id,\n  id,\n  name,\n  username,\n  email,\n  image,\n  bio,\n}\n": GET_AUTHOR_BY_IDResult;
